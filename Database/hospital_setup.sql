...
GRANT SELECT ON THONGBAO TO RL_BENHNHAN;
...
GRANT SELECT ON THONGBAO TO RL_KYTHUATVIEN;
...
GRANT SELECT, INSERT, UPDATE ON HSBA TO RL_DIEUPHOIVIEN;
GRANT SELECT, UPDATE ON HSBA_DV TO RL_DIEUPHOIVIEN;
GRANT SELECT ON THONGBAO TO RL_DIEUPHOIVIEN;
...
GRANT SELECT ON THONGBAO TO RL_BACSI;
